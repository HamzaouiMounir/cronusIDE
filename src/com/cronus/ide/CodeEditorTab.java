...
public class CodeEditorTab extends JTabbedPane {
		  ...
		  {
		    private CodeEditorTab tabbedPane;
		    ...
		    public TabCloseUI(CodeEditorTab pane) {
		    ...
		    public void mouseReleased(MouseEvent me) { if (closeUnderMouse(me.getX(), me.getY())) {
		        boolean isToCloseTab = CodeEditorTab.this.tabAboutToClose(this.selectedTab);
